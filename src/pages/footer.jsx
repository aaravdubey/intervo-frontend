...
export default function Footer() {
  return (
    ...
    <footer className="bg-teal-blue relative">
      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-14 lg:py-16">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-100 sm:text-center">© 2024 <a href="https://flowbite.com/" className="hover:underline">Intervo™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a href="#" className="text-gray-100 hover:text-gray-900 ms-5">
